...
namespace WebCrawlerTests
{
    class ServiceTests
    {
        private IJobAdvertService _jobAdvertService;
        ...
        public async Task GetJobAdvertsAsync_HasData_IfCollectionIsNotNull()
        {
            ...
            // Act
            var jobAdverts = await _jobAdvertService.GetJobAdvertsAsync();
        ...
        public async Task CreateJobAdvertAsync_CreatesAnArea_IfArgumentsAreValid()
        {
            ...
            //Act
            actual = await _jobAdvertService.CreateAsync(expected);
            bool cleanUpAreaTest = await _jobAdvertService.RemoveAsync(actual);
        ...
        public async Task GetJobAdvertByIdAsync_ReturnsAValidObject_IfArgumentIsValid()
        {
            ...
            testAdvert = await _jobAdvertService.CreateAsync(CreateTestJobAdvertObject());

            //Act
            requestedAdvert = await _jobAdvertService.GetByIdAsync(testAdvert.Id);

            //cleanup
            bool cleanUpAreaTest = await _jobAdvertService.RemoveAsync(requestedAdvert);
        ...
        public async Task UpdateAsync_UpdatesExistingObject_IfArgumentsIsValid()
        {
            ...
            updatedAdvert = await _jobAdvertService.UpdateAsync(newAdvert);

            //Cleanup
            bool cleanUpAreaTest = await _jobAdvertService.RemoveAsync(updatedAdvert);
        ...
        public async Task RemoveArea_ShouldRemoveArea()
        {
            ...
            //Act
            bool cleanupSuccess = await _jobAdvertService.RemoveAsync(testAdvert);
